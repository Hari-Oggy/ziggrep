pub const packages = struct {
    pub const @"clap-0.7.0-AAAAAEuZAQBi0wGiA9ADVHtBQjcimwmnmACVBhaXNJ-L" = struct {
        pub const build_root = "/home/hareesh/.cache/zig/p/clap-0.7.0-AAAAAEuZAQBi0wGiA9ADVHtBQjcimwmnmACVBhaXNJ-L";
        pub const build_zig = @import("clap-0.7.0-AAAAAEuZAQBi0wGiA9ADVHtBQjcimwmnmACVBhaXNJ-L");
...
pub const root_deps: []const struct { []const u8, []const u8 } = &.{
    ...
    .{ "clap", "clap-0.7.0-AAAAAEuZAQBi0wGiA9ADVHtBQjcimwmnmACVBhaXNJ-L" },
};
